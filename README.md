...
# RK137_Mirror Bot
This is a telegram bot writen in python for mirroring files on the internet to our beloved Google Drive modified from Slam Mirror Bot.
...
- **INDEX_URL**: (Optional field) Refer to https://github.com/rahulkhatri137/goindex The URL should not have any trailing '/'
...
<summary># Getting Google OAuth API credential file</summary>
